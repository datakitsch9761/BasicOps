...
public class Ball2 {
     ...
     */
        ...
        public Ball2(String mColor, String mName, int mCapacity, int mBounceRate) {
        ...
        public Ball2(String mColor, String mName) {
            color = mColor;
            name = mName;

        }

        public Ball2( String mColor, String mName, int mCapacity) {
